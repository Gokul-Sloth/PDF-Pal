      ...
      <header className="w-full bg-white dark:bg-gray-900 shadow-soft border-b border-muted-200 dark:border-gray-800">
        <nav className="container mx-auto max-w-4xl px-4 py-4 flex flex-row items-center justify-between">
            ...
            <div className="flex items-center gap-4 h-full">
              <div className="flex shrink-0 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/40 dark:to-red-800/20 p-2.5 rounded-2xl shadow-sm border border-red-100 dark:border-red-800/50 transition-transform duration-300 hover:scale-105">
                <img
                  src="/local-pdf-tools/pdf-file.svg"
                  alt="PDF Icon"
                  className="w-7 h-7 md:w-9 md:h-9 drop-shadow-sm"
                />
              </div>
